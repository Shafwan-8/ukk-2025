...
<!-- Mirrored from preview.tabler.io/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Jan 2025 00:40:01 GMT -->
...
<head>
    ...
    <!-- CSS files -->
    <link href="dist/css/tabler.mina0db.css?1736621409" rel="stylesheet"/>
    <link href="dist/css/tabler-flags.mina0db.css?1736621409" rel="stylesheet"/>
    <link href="dist/css/tabler-socials.mina0db.css?1736621409" rel="stylesheet"/>
    <link href="dist/css/tabler-payments.mina0db.css?1736621409" rel="stylesheet"/>
    <link href="dist/css/tabler-vendors.mina0db.css?1736621409" rel="stylesheet"/>
    <link href="dist/css/tabler-marketing.mina0db.css?1736621409" rel="stylesheet"/>
    <link href="dist/css/demo.mina0db.css?1736621409" rel="stylesheet"/>
    <style>
      @import url('../rsms.me/inter/inter.css');
    </style>
  </head>
  <body>
    <script src="dist/js/demo-theme.mina0db.js?1736621409"></script>
    <div class="page">
      <!-- Navbar -->
        ...
        <div class="container-xl">
          ...
          <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="d-none d-md-flex">
              <a href="index4965.html?theme=dark" class="nav-link px-0 hide-theme-dark" title="Enable dark mode" data-bs-toggle="tooltip"
		   data-bs-placement="bottom">
              ...
              <a href="index6a08.html?theme=light" class="nav-link px-0 hide-theme-light" title="Enable light mode" data-bs-toggle="tooltip"
		   data-bs-placement="bottom">
                  ...
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="icons.html" >
                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler.io/icons/icon/ghost -->
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="emails.html" >
                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler.io/icons/icon/mail-opened -->
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="illustrations.html" >
                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler.io/icons/icon/brand-figma -->
                    ...
                    <div class="d-flex mb-2">
                      ...
                      <div class="ms-auto">
                        <span class="text-green d-inline-flex align-items-center lh-1">
                          7% <!-- Download SVG icon from http://tabler.io/icons/icon/trending-up -->
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-baseline">
                      ...
                      <div class="me-auto">
                        <span class="text-green d-inline-flex align-items-center lh-1">
                          8% <!-- Download SVG icon from http://tabler.io/icons/icon/trending-up -->
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon ms-1"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 17l6 -6l4 4l8 -8" /><path d="M14 7l7 0l0 7" /></svg>
                        </span>
                      </div>
                    </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-baseline">
                      ...
                      <div class="me-auto">
                        <span class="text-green d-inline-flex align-items-center lh-1">
                          4% <!-- Download SVG icon from http://tabler.io/icons/icon/trending-up -->
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon ms-1"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 17l6 -6l4 4l8 -8" /><path d="M14 7l7 0l0 7" /></svg>
                        </span>
                      </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                      <div class="col-10">
                        ...
                        <div class="markdown text-secondary">
                          ...
                          download any of the 5790 icons in SVG, PNG or&nbsp;React and use them in your favourite design tools.
                        </div>
                        <div class="mt-3">
